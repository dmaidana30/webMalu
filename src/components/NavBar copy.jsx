...
export default () => {
  ...
  const navigation = [
    ...
    return (
        <nav className="bg-rose-200 border-b mx-2 my-2 rounded-lg">
            <div className="flex justify-between content-around space-x-8 py-3 px-4  mx-auto md:px-8">
                <div className="flex justify-center items-center bg-white rounded-full ">
                    {/* <a href="/" >
                        <img
                            src={`/img/LogoMALU.png`} 
                            width={120} 
                            height={50}
                            alt="Logo de MALU"
                        />
                ...
                <div className=" ">
                    <div className={`bg-rose-200 absolute z-20 w-full top-16 left-0  border-b lg:static lg:block lg:border-none ${menuState ? '' : 'hidden'}`}>
